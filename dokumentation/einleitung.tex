...
\section{Einleitung}
	Üblicherweise versuchen Spieleentwickler dem Spieler eine bestimmte Emotion zu vermitteln, meistens ist dies Spaß oder Freude.\footcite[Abstract]{persona} Dass durch Spiele Wissen vermittelt werden kann, ist wohlbekannt.\footcite{generalgameandlearning} Wenn diese Lernspiele betrachtet werden, fällt oft auf, dass der Spielspaß dabei vernachlässigt wird (siehe \ref{sssec:lernspielanalyse}).

...
\subsection{Functional and non-functional requirements}
	...
	\begin{itemize}
		...
		\item{ Spielmusik (wenn vorhanden) soll nicht stocken }
		\item{ Das Spiel zu starten soll unter einer Sekunde dauern }
	\end{itemize}
\subsection{Use Case Diagramm}
	Um die Entwicklung zu koordinieren und Aufgaben im Team zu verteilen wurde ein Use Case Diagramm\footnote{<TODO:Quelle>} ausgearbeitet.
	%\figur{usecases.pdf}{Use Case Diagramm}
...
\subsection{Game-Engine Evaluation}\label{ssec:engineeval}
	...
	\begin{description}
		...
		\end{description}
		Für die Evaluation wird ein Punktesystem verwendet, welches über fünf Ausprägungen verfügt. Die Ausprägungen sind dabei wie folgt aufgestellt: ++ > + > 0 > -- > -- {}--
	...
	\begin{tabl}{lcccc}{Game-Engine Evaluation}
		...
		\midrule
			...
			Networking				& + 	& + + 	& --		& --	\\
			Funktionsumfang 		& + + 	& + 	& + +		& +		\\
			Programmiersprache 		& + 	& 0 	& +			& +		\\
			Intuitivität 			& + 	& + + 	& +			& + +	\\
			Zusätzliche Software	& -- 	& 0 	& 0			& 0		\\ \hline

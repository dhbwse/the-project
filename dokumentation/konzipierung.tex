...
\subsection{Gamification Modell}\label{ssec:gamification-modell}
	...
	\begin{description}
		\item[Florian Klein]{
			Durch einen leichten einstieg und viel verrückten Rennspaß kann der Anfänger viel lernen. Durch eine einfache Steuerung, viele Extras und auch freunde bleibt er hoffentlich längere zeit am Spiel und somit Lernen begeistert. <TODO:Hoffentlich weg?>
		}
		\item[Joachim Wolf]{
			Der Lehrer hat die Möglichkeit durch Aufgaben und nicht Reaktionszeit oder Renntalent zu glänzen.
		}
		\item[Laura Dietz]{
			Die Rennfahrerin stört sich wahrscheinlich am meisten an den Aufgaben...
		}
		\item[Andy Klein]{
...
\subsection{Lernziele Umsetzung}
	...
	Die Idee ein Punktekonto für Aufgaben zu erstellen ist von dem \enquote{pay to win} Modell der Monetization\footcite{freemium} abgeleitet und \enquote{learn to win} getauft.
	\begin{description}

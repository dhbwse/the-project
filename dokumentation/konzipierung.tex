...
\subsection{Brainstorming \& Game Design}\label{ssec:idee}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item{Der Spieler wird von der Polizei verfolgt und bekommt beim geschnappt werden verschiedene Animationen des Scheiterns angezeigt.<TODO:Formulierung "geschnappt" ist umgangssprachlich}

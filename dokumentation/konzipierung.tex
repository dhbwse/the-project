...
\subsection{Brainstorming \& Game Design}\label{ssec:idee}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item{Optional: Die Level für den Spielfortschritt werden gegen computergesteuerte Bots statt, um das Level zu beenden muss der Spieler als erster das Ziel erreichen.}
		\end{itemize}

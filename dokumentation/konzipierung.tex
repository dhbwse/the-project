...
\subsection{Lernziele Umsetzung}
	...
	\begin{description}
		...
		\item[Aufgaben in Form von Weggabelungen]{
			Auf dem oberem Rand des Bildschirms taucht die Frage auf und kurz später eine Weggabelung, beispielsweise ein Tor mit zwei Durchgängen. Durch so eine spielerische Nutzung von Aufgaben kann ein Spieler motiviert werden zu lernen.
		}
	...
	\end{description}
	Im Optimalfall werden die verschiedenen Alternativen durch Spieltests empirisch belegt <TODO:spieletests oder so>.

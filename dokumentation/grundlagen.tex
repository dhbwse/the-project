...
\subsection{Lernspiele}
	...
	Somit sind einige Unterteilungen möglich, nach denen Lernspiel kategorisiert werden können:
	\begin{itemize}
	...
	\subsubsection{Analyse Spiele}\label{sssec:lernspielanalyse}
		...
		\begin{description}\obeylines
			...
			\item[Angry Birds]{
				\footcite{game-angrybirds} ist ein Minispiel für zwischen durch und sehr erfolgreich. Lernen war kein Ziel der Entwickler, potentiell kann das Spiel allerdings Kenntnisse der Mathematik und Physik vermitteln. Hier ist wichtig zu vermerken, dass Realismus vernachlässigt wird, trotzdem kann Wissen über Flugparabeln und Kräfte gelernt werden.

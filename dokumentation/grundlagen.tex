...
\subsection{Lernspiele}
	...
	\begin{enumerate}
		...
		\item{ Das zu Lernende ist fest im Spiel oder losgelöst davon ? }
	\end{enumerate}
	\subsubsection{Analyse Spiele}\label{sssec:lernspielanalyse}
		Hier sind ein paar Spiele
		\begin{tabl}{llll}{Analyse Lernspiele}
			\toprule
				Spielname & 1 & 2\footnotemark{} & 3 \\
			\midrule
				Gut\footnotemark{} & Wörter Lernen & Nein & Nein\\
				Angry Birds\footnotemark{} & Physik & Ja & Ja\\
				Need for Speed\footnotemark{} & Rennen fahren & Ja & Ja\\
				Crazy Machines 2\footnotemark{} & Puzzle/Physik & Ja & Ja\\
			\bottomrule
		\end{tabl}
		\addtocounter{footnote}{-4}% anzahl fußnoten in der tabelle +1
		\footnotetext{Dies ist die Sichtweise einer der Autoren und nicht Objektiv.}\stepcounter{footnote}%
		\footcitetext{game-nfs}\stepcounter{footnote}%
		\footcitetext{game-gut}\stepcounter{footnote}%
		\footcitetext{game-angrybirds}\stepcounter{footnote}%
		\footcitetext{game-crazymachine}

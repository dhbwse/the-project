...
\subsection{Integration in Lernplattform}
	Die Integration in die Lernplattform von Incekara und Wolske\footcite{lernplattform} konnte nicht umgesetzt werden. Die Möglichkeiten des Spiels, verschiedene Lernstandards gleichzeitig zu implementieren, sind nicht in der Plattform vorgesehen und die Implementierung einer Schnittstelle wäre nötig.

...
In diesem Kapitel sollen während des Prototypings aufgetretene Designentscheidungen aufgegriffen und erläutert werden. Dabei werden die Argumente sowie Meinungen von Testspielern einbezogen.
	...
	Für die Auswertung eines Rennens und somit für die Vergabe der Pokale und Punkte wird eine Tabelle eine Entscheidungstabelle hergeleitet. Die dafür relevanten Kriterien sind die Prozentzahl der korrekten Aufgaben und die Zeit, welche der Spieler für die Strecke gebraucht hat.
	...
	\begin{enumerate}
		\item{ Langsamer als die Zeit, aber näher als an der Zeit darunter. Für die letzte zeit wird hier ein maximal Abstand von $60$ Sekunden verwendet. Alles darunter ist \enquote{zu langsam} und in der folgenden Tabelle mit $<<$, lies viel langsamer markiert. }
		\item{ Schneller als die jeweilige Zeit, dabei nicht näher an der Zeit darüber. Für die Erste beziehungsweise schnellste Zeit wird diese Gruppe mit $60$ Sekunden Differenz definiert. Schnellere Zeiten sind unter $>>$ zusammengefasst. }
	\end{enumerate}
	...
	\end{enumerate}
	Mit diesen den beiden Achsen wurde dann die folgende Tabelle mit den jeweiligen gewonnenen Pokalen definiert:
...
Das Erreichen von Gold-Pokalen wird dabei absichtlich selten gewählt, um den Spieler zu fordern, motivieren und auch um realistische Ergebnisse zu setzen. Erst, wenn die Aufgaben und die Zeit perfektioniert wurden, gibt es einen Gold-Pokal.
...
In diesem Kapitel der Arbeit werden wichtige Schritte in der Entwicklung der Anwendung aufgegriffen. Dabei liegt der Fokus besonders auf Kernaspekten bzw. Kernproblemen, welche im Laufe der Entwicklung aufkommen.
	\subsubsection{Level Design}
		...
		\label{ssec:schlauch}\figur{Schlauchlevel.png}{Beispiel: Schlauchlevel}
		\label{ssec:statisch}\figur{Statische_Objekte.png}{Beispiel: Unbewegliche Objekte neben der Strecke}
		\label{ssec:beweglich}\figur{Bewegliche_Objekte.png}{Beispiel: Bewegliche Objekte auf der Strecke}
